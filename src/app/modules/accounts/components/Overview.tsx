        ...
        <div className='card-body p-9'>
          <div className='row mb-7'>
            ...
            <div className='col-lg-8'>
              <span className='fw-bolder fs-6 text-dark'>{fullName}</span>
            </div>
          </div>
          ...
          <div className='row mb-7'>
            ...
            <div className='col-lg-8 fv-row'>
              <span className='fw-bold fs-6'>{currentUser?.data?.email}</span>
            </div>
          </div>
          ...
          <div className='row mb-7'>
            ...
            <div className='col-lg-8 d-flex align-items-center'>
              <span className='fw-bolder fs-6 me-2'>{currentUser?.data?.phoneNumber}</span>
